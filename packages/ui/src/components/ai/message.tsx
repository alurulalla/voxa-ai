...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-teal-500 group-[.is-user]:to-teal-600 group-[.is-user]:text-primary-foreground",
      className,
    )}
    {...props}
  >
